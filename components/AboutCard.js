...
function AboutCard({ title, subtitle }) {
    return (
        <div className="flex flex-col items-start justify-end w-28 md:w-40 lg:w-60 h-36 md:h-64 lg:h-72 p-8 bg-gray-400 text-white md:mr-3 lg:mr-5 hover:bg-red-500">
            {/* Icon */}
